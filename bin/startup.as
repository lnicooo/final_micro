	...
	; Compiler options:
	;
	; build/teclado.p1 build/lcd.p1 build/main.p1 -Obin/proj_final_micro \
	; --chip=16f887 --mode=free -Q --warn=-9 -D_XTAL_FREQ=4000000 \
	; --ccmode=cci
	;
...
;	MCLRE = OFF, RE3/MCLR pin function is digital input, MCLR internally tied to VDD
;	Code Protection bit
